      ...
      <div class="container">
        <div class="row" >
          <div class="col-lg-6 mb-5">
            ...
            <form action="#" class="p-4 border rounded" style="width: 900px;">

              <div class="row form-group">
                <div class="col-md-12 mb-3 mb-md-0">
                  <label class="text-black" for="fname">이름</label>
                  <input type="text" id="fname" class="form-control" placeholder="이름을 입력해주세요.">
                </div>
              </div>
              ...
              <div class="row form-group">
                <div class="col-md-12 mb-3 mb-md-0">
                  ...
                  <input type="password" id="fname" class="form-control" placeholder="이메일을 입력해주세요.">
                </div>
              </div>
              
              <div class="row form-group mb-4">
                <div class="col-md-12 mb-3 mb-md-0">
                  <label class="text-black" for="fname">휴대폰</label>
                  <input type="password" id="fname" class="form-control" placeholder="전화번호를 입력해주세요.">
                </div>
              </div>
              
              <div class="row form-group">
                <div class="col-md-12 mb-3 mb-md-0">
                  <label class="text-black" for="fname">주소</label>
                  <input type="text" id="fname" class="form-control" placeholder="주소를 입력해주세요.">
                </div>
              </div>
              
              <div class="row form-group">
                <div class="col-md-12 mb-3 mb-md-0">
                  <label class="text-black" for="fname">프로필 사진</label>
                  <input type="file" id="fname" class="form-control" style="width: 850px; height: 300px;">
                </div>
              </div>
			...
			<!-- 돌아가기 -->
			  <div class="row form-group" style="float:left;">
                <div class="col-md-12">
                  <input type="submit" value="돌아가기" class="btn px-4 btn-primary text-white" >
                </div>
              </div>
