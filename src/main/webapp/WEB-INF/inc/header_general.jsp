            ...
            <div class="row align-items-center">
               ...
               <nav class="mx-auto site-navigation">
                  <ul class="site-menu js-clone-nav d-none d-xl-block ml-0 pl-0">
                     <li><a href="/guhau/jobs/getjob.do" class="nav-link active">채용</a></li>
                     <li><a href="/guhau/classes/classes.do">클래스</a></li>
                     <li><a href="/guhau/review/review.do">기업리뷰</a></li>
                     <li><a href="/guhau/community/community_view.do">커뮤니티</a>
                  </ul>
               </nav>
               ...
               <div
                  ...
                  <!-- 로그아웃 -->
                     <a href="/guhau/member/logoutok.do" class="btn btn-outline-white border-width-2 d-none d-lg-inline-block">
                        ...
                        <a href="/guhau/member/general/mypage.do" class="btn btn-primary border-width-2 d-none d-lg-inline-block">
