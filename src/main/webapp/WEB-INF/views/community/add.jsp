      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-8 blog-content">
			...
			<h3>커뮤니티 글쓰기</h3>
			<form method="POST" action="/guhau/community/addok.do">
				<table border="1">
				<tr>
					<th>카테고리</th>
					<td>
				...
				<tr>
					<th>내용</th>
					<td><textarea name="txt" id="txt" required></textarea></td>
				</tr>
				<tr>
					<th>직무</th>
					<td>
			...
			<div class="btns">
				<input type="button" value="돌아가기" onclick="location.href='/guhau/community/community_view.do'">
