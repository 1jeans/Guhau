			...
			<div class="container">
				<div class="row" >
					<div class="col-lg-6" style="margin: 0px auto;">
						<h2 class="mb-4">일반회원 로그인</h2>
						<form method="POST" action="/guhau/member/loginok.do" class="border rounded" style="padding: 1.5rem 1.5rem 0 1.5rem;">

							<div class="row form-group">
								<div class="col-md-12 mb-3 mb-md-0">
									<label class="text-black" for="m_id">ID</label> <input
										type="text" id="m_id" class="form-control" placeholder="ID" name="m_id">
								</div>
							</div>
							<div class="row form-group mb-4">
								<div class="col-md-12 mb-3 mb-md-0">
									<label class="text-black" for="m_pw">Password</label> <input
										type="password" id="m_pw" class="form-control"
										placeholder="Password" name="m_pw">
								</div>
							</div>
							...
							<div class="row form-group">
								<div class="col-md-12" style="margin-top: 10px;">
									...
									<span>|</span>
									<a href="/guhau/member/join.do">회원가입</a>
									<div style="margin-top: 10px;"><a href="/guhau/member/comlogin.do" style="color: cornflowerblue;">기업회원으로 로그인</a></div>
								</div>
							</div>
