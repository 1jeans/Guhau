						...
						<form method="POST"
							...
							<div class="row form-group">
								<div class="col-md-12 mb-3 mb-md-0">
									<!-- 씨X 기업 이름을 못바꿈 -->								
									<label class="text-black" for="m_name">기업 이름</label> <input
							...
							<div class="row form-group">
								<div class="col-md-12 mb-3 mb-md-0">
									<label class="text-black" for="m_email">회사 이메일</label> <input
							...
							<div class="row form-group">
								<div class="col-md-12 mb-3 mb-md-0">
									<label class="text-black" for="m_tel">회사 연락처</label> <input
							...
							<div class="row form-group" style="margin-bottom: 30px;">
								<div class="col-md-12 mb-3 mb-md-0">
									<label class="text-black" for="m_address">지역</label>
										<select class="selectpicker" data-width="100%" title="직종" name="region">
							...
							<div class="row form-group">
								<div class="col-md-12">
									<input type="submit" value="수정완료!" class="btn px-4 btn-primary text-white">
								</div>
							</div>
