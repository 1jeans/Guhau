...
@WebServlet("/review/creview_detail.do")
public class Creview_detail extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		RequestDispatcher dispatcher = req.getRequestDispatcher("/WEB-INF/views/review/creview_detail.jsp");
